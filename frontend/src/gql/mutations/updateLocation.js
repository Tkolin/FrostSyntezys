...
export default gql`mutation updateLocation($id: Int, $x: String, $y: String, $created_at: String, $updated_at: String, $name: String){
    updateLocation(id: $id, x: $x, y: $y, created_at: $created_at, updated_at: $updated_at, name: $name){
        id
        x
        y
        created_at
